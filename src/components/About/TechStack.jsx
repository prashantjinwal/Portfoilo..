...
const SKILLS = [
  ...
  { name: "Github", x: 28, y: 68, src: "/icons_stack/GitHub.svg" },
  { name: "Javascript", x: 48, y: 78, src: "/icons_stack/JavaScript.svg" },
  { name: "Express", x: 88, y: 38, src: "/icons_stack/express.png" },
